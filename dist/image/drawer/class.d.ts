...
export declare class ImageDrawer {
     ...
     * ```
     */
    rectangle(x: number, y: number, width: number, height: number, options?: actions.DrawOptions): this;
    /**
     ...
     * ```
     */
    circle(centerX: number, centerY: number, radius: number, options?: actions.DrawOptions): this;
    /**
     ...
     * ```
     */
    line(x1: number, y1: number, x2: number, y2: number, options?: actions.DrawOptions): this;
    /**
     ...
     * ```
     */
    fillRect(x: number, y: number, width: number, height: number, color?: {
        r: number;
        g: number;
        b: number;
    }): this;
     ...
     * ```
     */
    fillCircle(centerX: number, centerY: number, radius: number, color?: {
        r: number;
        g: number;
        b: number;
    }): this;
     ...
     * ```
     */
    ellipse(centerX: number, centerY: number, radiusX: number, radiusY: number, options?: actions.EllipseOptions): this;
    /**
    ...
    polygon(points: Array<{
        x: number;
        y: number;
    }>, options?: actions.PolygonOptions): this;
    /**
     ...
     * ```
     */
    arrow(x1: number, y1: number, x2: number, y2: number, options?: actions.DrawOptions & {
        arrowSize?: number;
    }): this;
    /**
     ...
     * ```
     */
    cross(centerX: number, centerY: number, size: number, options?: actions.DrawOptions): this;
    /**
     ...
     * ```
     */
    arc(centerX: number, centerY: number, radius: number, startAngle: number, endAngle: number, options?: actions.DrawOptions): this;
    /**
     ...
     * ```
     */
    text(x: number, y: number, text: string, options?: actions.TextOptions): this;
}
